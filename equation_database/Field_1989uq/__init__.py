...
def equation_2_3_32(
    ...
    """
    return sympy.Eq( sympy.Derivative(sigma, x_1, x_2)/sigma_0, 2*alpha_s/3/sympy.pi * (x_1**2 + x_2**2)/((1-x_1)*(1-x_2)))
...
def equation_4_3_20(
    ...
    """
    return e**2*e_q**2* g_s**2 *frac("4/8")*frac("1/2") * 8 * (u/t + t/u + 2*Q**2*(u+t+Q**2)/(t*u))
